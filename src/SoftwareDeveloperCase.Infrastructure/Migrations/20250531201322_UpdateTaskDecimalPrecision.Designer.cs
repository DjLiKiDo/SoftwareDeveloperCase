...
namespace SoftwareDeveloperCase.Infrastructure.Migrations
{
    ...
    [Migration("20250531201322_UpdateTaskDecimalPrecision")]
    partial class UpdateTaskDecimalPrecision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Core.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Core.Task", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Core.TaskComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Core.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Core.TeamMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Core.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 907, DateTimeKind.Utc).AddTicks(1070),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 907, DateTimeKind.Utc).AddTicks(1090),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 907, DateTimeKind.Utc).AddTicks(1100),
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Identity.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 906, DateTimeKind.Utc).AddTicks(9890),
                            Name = "Read"
                        },
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 906, DateTimeKind.Utc).AddTicks(9900),
                            Name = "Add"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Identity.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2d7aa3b0-f221-4753-b77f-ff261858a13a"),
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 907, DateTimeKind.Utc).AddTicks(40),
                            Name = "Employee"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Identity.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 907, DateTimeKind.Utc).AddTicks(510),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 907, DateTimeKind.Utc).AddTicks(520),
                            PermissionId = new Guid("9a6ae1d8-0688-43d4-b1ce-2a13608fa68c"),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 907, DateTimeKind.Utc).AddTicks(530),
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Identity.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 907, DateTimeKind.Utc).AddTicks(1230),
                            RoleId = new Guid("2d7aa3b0-f221-4753-b77f-ff261858a13a"),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 20, 13, 21, 907, DateTimeKind.Utc).AddTicks(1240),
                            RoleId = new Guid("2d7aa3b0-f221-4753-b77f-ff261858a13a"),
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Core.Project", b =>
                {
                    b.HasOne("SoftwareDeveloperCase.Domain.Entities.Core.Team", "Team")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Core.Task", b =>
                {
                    b.HasOne("SoftwareDeveloperCase.Domain.Entities.Core.User", "AssignedTo")
                        .WithMany("AssignedTasks")
                        .HasForeignKey("AssignedToId");

                    b.HasOne("SoftwareDeveloperCase.Domain.Entities.Core.Task", "ParentTask")
                        .WithMany("SubTasks")
                        .HasForeignKey("ParentTaskId");

                    b.HasOne("SoftwareDeveloperCase.Domain.Entities.Core.Project", "Project")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Core.TaskComment", b =>
                {
                    b.HasOne("SoftwareDeveloperCase.Domain.Entities.Core.User", "Author")
                        .WithMany("TaskComments")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SoftwareDeveloperCase.Domain.Entities.Core.Task", "Task")
                        .WithMany("Comments")
                        .HasForeignKey("TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Core.TeamMember", b =>
                {
                    ...
                    b.HasOne("SoftwareDeveloperCase.Domain.Entities.Core.User", "User")
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Identity.Role", b =>
                {
                    b.HasOne("SoftwareDeveloperCase.Domain.Entities.Identity.Role", "ParentRole")
                        .WithMany()
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Identity.RolePermission", b =>
                {
                    ...
                    b.HasOne("SoftwareDeveloperCase.Domain.Entities.Identity.Role", "Role")
                        .WithMany("RolePermissions")
