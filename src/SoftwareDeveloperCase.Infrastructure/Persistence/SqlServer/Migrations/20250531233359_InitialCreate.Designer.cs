...
namespace SoftwareDeveloperCase.Infrastructure.Persistence.SqlServer.Migrations
{
    ...
    [Migration("20250531233359_InitialCreate")]
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Identity.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(1970),
                            Name = "Read"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(1980),
                            Name = "Delete"
                        });
                });
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Identity.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(2210),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(2220),
                            PermissionId = new Guid("9a6ae1d8-0688-43d4-b1ce-2a13608fa68c"),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(2230),
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Identity.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(2410),
                            RoleId = new Guid("2d7aa3b0-f221-4753-b77f-ff261858a13a"),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(2420),
                            RoleId = new Guid("9eca8d57-f7ca-4f8d-9c83-73b659225ae4"),
                            UserId = new Guid("64a19c7d-a7a9-4481-a498-7df87f341da4")
                        },
                        new
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(2180),
                            Name = "Employee"
                        },
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(2190),
                            Name = "Manager",
            ...
            modelBuilder.Entity("SoftwareDeveloperCase.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2d7aa3b0-f221-4753-b77f-ff261858a13a"),
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(2360),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "InitialSeed",
                            CreatedOn = new DateTime(2025, 5, 31, 23, 33, 58, 473, DateTimeKind.Utc).AddTicks(2370),
